...
func InitializeApp() (*gin.Engine, func(), error) {
	...
	uploadService := services.NewUploadService(client, programRepository, staffService, projectRoleService, projectService, courseService, configService, studentService)
