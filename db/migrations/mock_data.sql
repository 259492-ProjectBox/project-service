...
VALUES
  ...
  ('academic_year', true, 1), ('semester', true, 1), ('section_id', true, 1),
  ...
  ('academic_year', true, 2), ('semester', true, 2), ('section_id', true, 2),
  ...
  ('academic_year', true, 3), ('semester', true, 3), ('section_id', true, 3),
  ...
  ('academic_year', true, 4), ('semester', true, 4), ('section_id', true, 4),
  ...
  ('academic_year', true, 5), ('semester', true, 5), ('section_id', true, 5),
  ...
  ('academic_year', true, 6), ('semester', true, 6), ('section_id', true, 6),
  ...
  ('academic_year', true, 7), ('semester', true, 7), ('section_id', true, 7),
  ...
  ('academic_year', true, 8), ('semester', true, 8), ('section_id', true, 8),
  ...
  ('academic_year', true, 9), ('semester', true, 9), ('section_id', true, 9),
  ...
  ('academic_year', true, 10), ('semester', true, 10), ('section_id', true, 10),
