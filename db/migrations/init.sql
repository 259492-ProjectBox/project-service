...
ALTER TABLE "project_status" ADD FOREIGN KEY ("major_id") REFERENCES "majors" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "projects" ADD FOREIGN KEY ("status_id") REFERENCES "project_status" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
